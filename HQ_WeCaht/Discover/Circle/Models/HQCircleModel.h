...
extern NSString *const kWBLinkHrefName;
extern NSString *const kWBLinkURLName;
extern NSString *const kWBLinkTagName;
extern NSString *const kWBLinkTopicName;
extern NSString *const kWBLinkAtName;
...
@interface HQCircleModel : NSObject
...
// 以下是数据
@property (nonatomic, strong) HQCircleWBStatus *status;
