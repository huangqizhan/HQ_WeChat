...
#import "HQCircleContentModel.h"


/**
 一个图片的元数据
 */
@implementation HQCirclePictureMetadata 
...
@implementation  HQCirclePicture
+ (NSDictionary *)modelCustomPropertyMapper {
    return @{@"picID" : @"pic_id",
             @"keepSize" : @"keep_size",
             @"photoTag" : @"photo_tag",
...
- (BOOL)modelCustomTransformFromDictionary:(NSDictionary *)dic {
    HQCirclePictureMetadata *meta = _large ? _large : _largest ? _largest : _original;
...
+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{@"picIds" : [NSString class],
             @"picInfos" : [HQCirclePicture class]};
}
- (BOOL)modelCustomTransformFromDictionary:(NSDictionary *)dic {
    ...
    if (_picIds.count != 0) {
        ...
        for (NSString *picId in _picIds) {
            HQCirclePicture *pic = _picInfos[picId];
            if (pic) {
                [pics addObject:pic];
            }
        }
...
@implementation  HQCircleWBTopic
+ (NSDictionary *)modelCustomPropertyMapper {
...
@implementation  HQCircleWBButtonLink

@end

@implementation HQCircleWBPageInfo
+ (NSDictionary *)modelCustomPropertyMapper {
...
+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{@"buttons" : [HQCircleWBButtonLink class]};
}

@end


@implementation  HQCircleWBStatusTitle
+ (NSDictionary *)modelCustomPropertyMapper {
...
@implementation  HQCircleWBStatus
+ (NSDictionary *)modelCustomPropertyMapper {
    return @{@"statusID" : @"id",
             @"createdAt" : @"created_at",
...
+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{@"picIds" : [NSString class],
             @"picInfos" : [HQCirclePicture class],
             @"urlStruct" : [HQCircleWBURL class],
             @"topicStruct" : [HQCircleWBTopic class],
             @"tagStruct" : [HQCircleWBTag class]};
}
- (BOOL)modelCustomTransformFromDictionary:(NSDictionary *)dic {
    // 自动 model-mapper 不能完成的，这里可以进行额外处理
    _pics = nil;
...
@implementation  HQCircleWBTimelineItem
...
+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{@"statuses" : [HQCircleWBStatus class]};
}

@end


@implementation  HQCircleWBEmoticon
...
@implementation  HQCircleWBEmoticonGroup
+ (NSDictionary *)modelCustomPropertyMapper {
    return @{@"groupID" : @"id",
...
+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{@"emoticons" : [HQCircleWBEmoticon class]};
}
- (BOOL)modelCustomTransformFromDictionary:(NSDictionary *)dic {
    [_emoticons enumerateObjectsUsingBlock:^(HQCircleWBEmoticon *emoticon, NSUInteger idx, BOOL *stop) {
        emoticon.group = self;
    }];
    return YES;
}
