...
/**
 一个图片的元数据
 */
@interface  HQCirclePictureMetadata : NSObject
...
/**
 图片
 */
@interface  HQCirclePicture :NSObject
@property (nonatomic, strong) NSString *picID;
@property (nonatomic, strong) NSString *objectID;
@property (nonatomic, assign) int photoTag;
@property (nonatomic, assign) BOOL keepSize; ///< YES:固定为方形 NO:原始宽高比
@property (nonatomic, strong) HQCirclePictureMetadata *thumbnail;  ///< w:180
@property (nonatomic, strong) HQCirclePictureMetadata *bmiddle;    ///< w:360 (列表中的缩略图)
@property (nonatomic, strong) HQCirclePictureMetadata *middlePlus; ///< w:480
@property (nonatomic, strong) HQCirclePictureMetadata *large;      ///< w:720 (放大查看)
@property (nonatomic, strong) HQCirclePictureMetadata *largest;    ///<       (查看原图)
@property (nonatomic, strong) HQCirclePictureMetadata *original;   ///<
@property (nonatomic, assign) WBPictureBadgeType badgeType;
...
/**
 链接
 */
@interface HQCircleWBURL : NSObject
...
@property (nonatomic, strong) NSDictionary<NSString *, HQCirclePicture *> *picInfos;
@property (nonatomic, strong) NSArray<HQCirclePicture *> *pics;
@end
...
/**
 话题
 */
@interface HQCircleWBTopic : NSObject
...
/**
 标签
 */
@interface HQCircleWBTag : NSObject
...
/**
 按钮
 */
@interface  HQCircleWBButtonLink : NSObject
...
/**
 ...
 -----------------------------
 */
@interface HQCircleWBPageInfo : NSObject
...
@property (nonatomic, strong) NSArray<HQCircleWBButtonLink *> *buttons;
...
/**
 微博标题
 */
@interface HQCircleWBStatusTitle : NSObject
...
/**
 用户
 */
@interface HQCircleWBUser : NSObject
...
/**
 微博
 */
@interface HQCircleWBStatus : NSObject
...
@property (nonatomic, strong) HQCircleWBUser *user;
@property (nonatomic, assign) int32_t userType;

@property (nonatomic, strong) HQCircleWBStatusTitle *title; ///< 标题栏 (通常为nil)
...
@property (nonatomic, strong) HQCircleWBStatus *retweetedStatus; ///转发微博

@property (nonatomic, strong) NSArray<NSString *> *picIds;
@property (nonatomic, strong) NSDictionary<NSString *, HQCirclePicture *> *picInfos;

@property (nonatomic, strong) NSArray<HQCirclePicture *> *pics;
@property (nonatomic, strong) NSArray<HQCircleWBURL *> *urlStruct;
@property (nonatomic, strong) NSArray<HQCircleWBTopic *> *topicStruct;
@property (nonatomic, strong) NSArray<HQCircleWBTag *> *tagStruct;
@property (nonatomic, strong) HQCircleWBPageInfo *pageInfo;
...
/**
 一次API请求的数据
 */
@interface HQCircleWBTimelineItem : NSObject
...
@property (nonatomic, strong) NSArray<HQCircleWBStatus *> *statuses;
/*
 groupInfo
 trends
 */
...
@interface HQCircleWBEmoticon : NSObject
...
@property (nonatomic, weak) HQCircleWBEmoticonGroup *group;
@end



@interface HQCircleWBEmoticonGroup : NSObject
...
@property (nonatomic, strong) NSArray<HQCircleWBEmoticon *> *emoticons;
@end
