...
@implementation HQPopoverViewCell
...
- (void)setHighlighted:(BOOL)highlighted animated:(BOOL)animated {
    ...
    if (highlighted) {
        self.backgroundColor = _style == HQPopoverActionDefauleStyle ? [UIColor colorWithRed:0.90 green:0.90 blue:0.90 alpha:1.00] : [UIColor colorWithRed:0.23 green:0.23 blue:0.23 alpha:1.00];
    } else {
...
+ (UIColor *)bottomLineColorForStyle:(HQPopoverActionStyle )style {
    return style == HQHQPopoverActionDarkStyle ? [UIColor colorWithRed:0.75 green:0.75 blue:0.75 alpha:1.00] : [UIColor colorWithRed:0.4 green:0.4 blue:0.4 alpha:1.00];
}
