...
/**
 ...
 @paramjk context      A new bitmap content created by layer.
 @paramkl size         The content size (typically same as layer's bound size).
 @paramkjhbj isCancelled  If this block returns `YES`, the method should cancel the
...
/**
 ...
 @paramkj layer  The layer.
 @paramlk finished  If the draw process is cancelled, it's `NO`, otherwise it's `YES`;
 */
