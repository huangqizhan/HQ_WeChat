...
CGFloat const CHATHEADIMAGEWIDTH = 40;
...
NSString *const MineTextCellId      = @"MineTetxCellId";
NSString *const MineImageCellId     = @"MineImageCellId";
NSString *const MineGifCellId       = @"MineGifCellId";
NSString *const MineVidioCellId     = @"MineVidioCellId";
NSString *const MineVoiceCellId     = @"MineVoiceCellId";
NSString *const MineFileCellId      = @"MineFileCellId";
NSString *const DateMessageCellId   = @"HQChatDateCellId";
NSString *const MineRecordingCellId = @"HQRecordingCellId";
NSString *const MineLocationCellId  = @"MineLocationCellId";


NSString *const OtherTextCellid     = @"OtherTetxCellId";
NSString *const OtherImageCellId    = @"OtherImageCellId";
NSString *const OtherGifCellId      = @"OtherGifCellId";
NSString *const OtherVidioCellId    = @"OtherVodioCellId";
NSString *const OtherVoiceCellId    = @"OtherVoiceCellId";
NSString *const OtherFileCellid     = @"OtherFileCellId";
NSString *const OtherLocationCellId = @"OtherLocationCellId";
...
NSString *const NotificationReceiveNewMessageNotification = @"NotificationReceiveNewMessageNotification";

NSString *const HQ_WeChatAMapKey = @"9e4bc9156f8af1aa785bfa4651aced01";
NSString *const HQ_WeIsFirstInstallKey = @"HQ_WeIsFirstInstallKey";

NSString *const allPOISearchTypes = @"汽车服务|汽车销售|汽车维修|摩托车服务|餐饮服务|购物服务|生活服务|体育休闲服务|医疗保健服务|住宿服务|风景名胜|商务住宅|政府机构及社会团体|科教文化服务|交通设施服务|金融保险服务|公司企业|道路附属设施|地名地址信息|公共设施";
