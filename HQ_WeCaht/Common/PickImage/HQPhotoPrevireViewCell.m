...
@implementation HQPhotoPrevireViewCell

- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        self.backgroundColor = [UIColor blackColor];
        self.previewView = [[HQPhotoPrevireView alloc] initWithFrame:self.bounds];
...
@interface HQPhotoPrevireView ()<UIScrollViewDelegate>

@end


@implementation HQPhotoPrevireView
...
- (void)setModel:(HQAssetModel *)model {
    ...
    if (model.type == HQAssetModelMediaTypePhotoGif) {
        [[HQImageManager manager] getOriginalPhotoDataWithAsset:model.asset completion:^(NSData *data, NSDictionary *info, BOOL isDegraded) {
            if (!isDegraded) {
...
- (void)setAsset:(id)asset {
    _asset = asset;
    [[HQImageManager manager] getPhotoWithAsset:asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded,id identifier) {
