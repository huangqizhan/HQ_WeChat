...
YYSSSYNTH_DUMMY_CLASS(UIButton_Add)
...
- (WebImageSetter *)setterForState:(NSNumber *)state;
- (WebImageSetter *)lazySetterForState:(NSNumber *)state;
@end
...
- (WebImageSetter *)setterForState:(NSNumber *)state {
    ...
    WebImageSetter *setter = _dic[state];
...
- (void)_setImageWithURL:(NSURL *)imageURL
    ...
    WebImageSetter *setter = [dic lazySetterForState:state];
...
- (void)_cancelImageRequestForSingleState:(NSNumber *)state {
    _YYWebImageSetterDicForButton *dic = objc_getAssociatedObject(self, &_YYWebImageSetterKey);
    WebImageSetter *setter = [dic setterForState:state];
    if (setter) [setter cancel];
}

- (NSURL *)imageURLForState:(UIControlState)state {
    _YYWebImageSetterDicForButton *dic = objc_getAssociatedObject(self, &_YYWebImageSetterKey);
    WebImageSetter *setter = [dic setterForState:UIControlStateSingle(state)];
