...
//  YYKitStudy
//
//  Created by GoodSrc on 2017/12/5.
...
/*
 __covariant - 协变性， 数组中的对象子类型可以强转到父类型
 __contravariant - 逆变性， 数组中的对象父类型可以强转到子类型
...
/**
 <泛型>
 */
@interface NSArray < __covariant ObjectType>(Add)
...
@interface NSMutableArray<ObjectType> (Add)
