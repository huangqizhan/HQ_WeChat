...
YYSSSYNTH_DUMMY_CLASS(NSString_Add)
...
- (void)testAction{
    ...
    NSCharacterSet *characterSet = [NSCharacterSet characterSetWithCharactersInString:@"我学N"];
    ...
    NSString *str1 = @"7sjf78sf990s";
    NSLog(@"set----%@",[str1 componentsSeparatedByCharactersInSet:set]);
    
    NSCharacterSet *invertedSet = [[NSCharacterSet characterSetWithCharactersInString:@"0123456789"] invertedSet];
    NSLog(@"invertedSet----%@",[str1 componentsSeparatedByCharactersInSet:invertedSet]);
