...
NSCharacterSet *TextVerticalFormRotateCharacterSet() {
...
NSCharacterSet *TextVerticalFormRotateAndMoveCharacterSet() {
    static NSMutableCharacterSet *set;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        set = [NSMutableCharacterSet new];
...
CGAffineTransform TextCGAffineTransformGetFromViews(UIView *from, UIView *to) {
    ...
    return TextCGAffineTransformGetFromPoints(before, after);
}
...
UIApplication *TextSharedApplication() {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
    return TextIsAppExtension() ? nil : [UIApplication performSelector:@selector(sharedApplication)];
