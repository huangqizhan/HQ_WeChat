...
#import "HQPlayVoiceMineButton.h"
#import "HQAudioPlayerManager.h"



@interface HQPlayVoiceMineButton ()<HQAudioPlayDelegate>
...
@implementation HQPlayVoiceMineButton
...
- (void)initialize{
    ...
    _contentButton = [[UIButton alloc] initWithFrame:CGRectMake(5, 0, 80, 40)];
    [_contentButton setImage:[UIImage imageNamed:@"SenderVoiceNodePlaying"] forState:UIControlStateNormal];
    ...
    [_contentButton setImageEdgeInsets:UIEdgeInsetsMake(0, 45, 0, 0)];
...
- (void)setMessageModel:(ChatMessageModel *)messageModel{
    ...
    _durationLabel.right = self.begImageView.left+2;
...
- (NSArray *)animationImagesArray{
    if (_animationImagesArray == nil) {
        _animationImagesArray = @[[UIImage imageNamed:@"SenderVoiceNodePlaying001"],
