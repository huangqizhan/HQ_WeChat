...
@interface HQChatLocationOtherCell ()
...
@implementation HQChatLocationOtherCell
...
- (void)setIsEdiating:(BOOL)isEdiating{
    ...
    self.begView.left = self.headImageView.right+10;
}
...
- (UIView *)begView{
    if (_begView == nil) {
        _begView = [[UIView alloc]initWithFrame:CGRectMake(65, 10, App_Frame_Width*0.6, (APP_Frame_Height)/4.0)];
