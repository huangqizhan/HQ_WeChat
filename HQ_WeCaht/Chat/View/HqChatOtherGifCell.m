...
@implementation HqChatOtherGifCell
...
//    }
//    self.animationView.left = self.headImageView.right+10;
}
...
//        _contentLabel = [[UILabel alloc] initWithFrame:CGRectMake(App_Frame_Width-50, 20, 50, 20)];
