...
#import "HQChatMineVoiceCell.h"
#import "HQPlayVoiceMineButton.h"
#import "HQActionSheet.h"
#import "UIApplication+HQExtern.h"


@interface HQChatMineVoiceCell ()<HQPlayVoiceMineButtonDelegate>

@property (nonatomic,strong) HQPlayVoiceMineButton *playButton;

@end

@implementation HQChatMineVoiceCell
///MineVoiceCellId
...
- (void)setMessageModel:(ChatMessageModel *)messageModel{
    ...
    self.playButton.right = self.headImageView.left-10;
...
#pragma mark - Getter
- (HQPlayVoiceMineButton *)playButton{
    if (_playButton == nil) {
        _playButton = [[HQPlayVoiceMineButton alloc] initWithFrame:CGRectMake(App_Frame_Width-160, 10, 100, 50)];
