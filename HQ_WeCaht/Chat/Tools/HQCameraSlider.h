...
@protocol HQCameraSliderDelegate ;

@interface HQCameraSlider : UIControl
...
@property (nonatomic,assign) id <HQCameraSliderDelegate>delegate;
...
@protocol HQCameraSliderDelegate <NSObject>

@optional

- (void)didChangeValueSCSlider:(HQCameraSlider*)slider value:(CGFloat)value;
- (void)didSCSliderTouchEnd:(HQCameraSlider*)slider value:(CGFloat)value isTouch:(BOOL)isTouchEnd;
